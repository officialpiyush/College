...
void constFolding()
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        for (j = 0; j < strlen(QUAD[i].arg1); j++)
        {
            ...
            {
                flag1 = 0;
                printf("Operand1 is not constant, Constant folding can not applied to quadruple %d\n", i);
                break;
            }
        }
        for (j = 0; j < strlen(QUAD[i].arg2); j++)
        {
            ...
            {
                flag2 = 0;
                printf("Operand2 is not constant, Constant folding can not applied to quadruple %d\n", i);
                break;
            }
        }
        if (flag1 == 1 && flag2 == 1)
